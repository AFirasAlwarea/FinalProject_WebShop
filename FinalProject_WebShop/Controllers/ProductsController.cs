...
namespace FinalProject_WebShop.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,Price,Inventory,Availability,SellerId,Photo_URL")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,Price,Inventory,Availability,SellerId,Photo_URL")] Product product)
        {
            if (ModelState.IsValid)
            {
